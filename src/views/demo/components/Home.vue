        ...
        <el-col :span="24" class="header">
            ...
            <el-col :span="10" class="userinfo">
                <ul class="pull-right nav">
                    <li class="green">
                        <a>
                            <i class="fa fa-tasks"></i> <span class="badge badge-grey">4</span>
                        </a>
                    </li>

                    <li class="purple">
                        <a>
                            <i class="fa fa-bell icon-animated-bell"></i> <span
                    ...
                    <li class="light-blue">
                        <a>
                            <el-dropdown trigger="hover">
                                <!--<span >
                                    <img :src="this.sysUserAvatar"  class="nav-user-photo"/>
                                </span>
                    ...
                    <template v-for="(item,index) in $router.options.routes" v-if="!item.hidden">
                        <el-submenu :index="index+''" v-if="item.children">
                            ...
                            <template v-for="(subitem,subindex) in item.children" v-if="!subitem.hidden">
                                <el-submenu :index="subindex+''" v-if="subitem.children">
                                    <template slot="title"><i :class="subitem.iconCls"></i>{{subitem.name}}</template>
                                    <el-menu-item v-for="subchild in subitem.children" :index="subchild.path"
                                                  :key="subchild.path" v-if="!subchild.hidden">{{subchild.name}}
                                    </el-menu-item>
                                </el-submenu>
                                <el-menu-item v-if="!subitem.children" :index="subitem.path"><i
                                        :class="subitem.iconCls"></i>{{subitem.name}}
                                </el-menu-item>
...
<style scoped lang="scss">
    ...
    .container {
        ...
        .main {
            ...
            .menu-collapsed {
                flex: 0 0 $aside-collapsed-width;
            ...
            .el-menu-item {
                min-width: $aside-expanded-width;
            }
            .content-container {
                // background: #f1f2f7;
                flex: 1;

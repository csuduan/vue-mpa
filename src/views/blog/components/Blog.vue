        ...
        <div class="side">
          <side-section>
            <div slot="sidecontent">
              ...
              <div class="pres">
              <a href="" class="pic">
              <img src="@/assets/images/dq.jpg" alt="我的头像">
              </a>
              <a href="" class="detail">
                <span class="item-info">
                  <span class="item-title">DQ</span>
              ...
              <div class="social">
                ...
                <a data-balloon="github" href="https://github.com/csuduan" rel="nofollow" class="icon"><i class="fa fa-github" style="background-color: #55acee;"></i></a>
                <el-popover
                  ref="youxiang"
                  placement="bottom"
                  title="我的邮箱"
